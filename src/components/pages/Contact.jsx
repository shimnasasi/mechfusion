        ...
        <div className="contact-main-wrapper">
          <div className="contact-information-wrapper">
            <div className="contact-address-card">
              ...
              <span className="contact-info-para">enquiry.mechfusion@gmail.com</span>
            </div>
            <hr />
            <div className="contact-address-card">
              <div className="contactIcon">
              ...
              <span className="contact-info-para">+97 1234567890</span>
            </div>
            <hr />
            <div className="contact-address-card">
              <div className="contactIcon">
              ...
              Mechfusion,Yelahanka Newtown,Bangalore,Karnataka India – 560064
              </span>
            </div>
          </div>
